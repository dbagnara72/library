...
% i1m = 10;
% p_iron = 10e3;
% trafo = three_phase_transformer_setup(name, pwr_nom, u1_nom, u2_nom, f_nom, eta, ucc, i1m, p_iron);
...
classdef three_phase_transformer_setup
    ...
    methods
        ...
        function obj = three_phase_transformer_setup(name, pwr_nom, u1_nom, u2_nom, f_nom, eta, ucc, i1m, p_iron)
            if nargin > 0
                obj.name = name;
                obj.pwr_nom = pwr_nom;
                obj.u1_nom = u1_nom;
